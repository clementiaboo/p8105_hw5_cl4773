...
The corresponding 95% confidence interval is (`r baltimore_prop_test_tidy |> pull(conf.low) |> round(2)`,`r baltimore_prop_test_tidy |> pull(conf.high) |> round(2)`).
