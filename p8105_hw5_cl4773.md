...
![](p8105_hw5_cl4773_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
There is a positive relationship between effect size and power. As μ
...
![](p8105_hw5_cl4773_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->

The sample average of μ among the tests where the null is rejected is
not close to the true value of μ. This happens because the estimate of μ
...
average μ in this selected subset does not necessarily reflect the true
mean.
...
Upon further inspection, the record with uid “Tul-000769” was found to
have an incorrect state value. The state should be “OK” rather than
“AL”, based on the city name (“Tulsa”), the latitude and longitude, and
consistency with the surrounding uid entries. The state value was
therefore corrected to “OK” in the dataset.
...
![](p8105_hw5_cl4773_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
